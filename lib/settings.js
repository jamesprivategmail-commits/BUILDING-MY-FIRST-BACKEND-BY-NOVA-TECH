...
function readSettings() {
    try {
        ...
        return { mode: 'public', antilinkGroups: {}, welcomeGroups: {}, goodbyeGroups: {}, prefix: null, warnings: {}, anticall: false };
    }
}
...
export function isAnticallEnabled() {
    return !!readSettings().anticall;
}

export function setAnticall(enabled) {
    const settings = readSettings();
    settings.anticall = enabled;
    writeSettings(settings);
}